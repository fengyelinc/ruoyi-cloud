...
import com.iuiga.common.core.utils.poi.ExcelUtil;
import com.iuiga.common.core.web.controller.BaseController;
import com.iuiga.common.core.web.domain.AjaxResult;
import com.iuiga.common.core.web.page.TableDataInfo;
import com.iuiga.common.log.annotation.Log;
import com.iuiga.common.log.enums.BusinessType;
import com.iuiga.common.security.annotation.InnerAuth;
import com.iuiga.common.security.annotation.RequiresPermissions;
...
import com.iuiga.system.domain.SysRole;
import com.iuiga.system.domain.SysUser;
import com.iuiga.system.service.ISysConfigService;
import com.iuiga.system.service.ISysPermissionService;
import com.iuiga.system.service.ISysRoleService;
...
public class SysUserController extends BaseController
{
    ...
    public R<LoginUser> info(@PathVariable("username") String username)
    {
        ...
        sysUserVo.setSysUserVo(convertDataVo(sysUser));
        sysUserVo.setRoles(roles);
        sysUserVo.setPermissions(permissions);
        return R.ok(sysUserVo);
    }

    private SysUserVo convertDataVo(SysUser user) {
    ...
    public R<Boolean> register(@RequestBody SysUser sysUserVo)
    {
    ...
    public AjaxResult getInfo(@PathVariable(value = "userId", required = false) Long userId)
    {
        ...
        {
            SysUser sysUserVo = userService.selectUserById(userId);
            ajax.put(AjaxResult.DATA_TAG, sysUserVo);
            ajax.put("roleIds", sysUserVo.getRoles().stream().map(SysRole::getRoleId).collect(Collectors.toList()));
        }
        return ajax;
    }
